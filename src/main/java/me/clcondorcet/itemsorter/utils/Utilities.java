...
public class Utilities {
    ...
    public static boolean isContainer(Material mat){
        return mat.equals(Material.CHEST) || mat.equals(Material.TRAPPED_CHEST) || ItemSorter.versionHandler.isBarrelType(mat);
    }

    public static boolean isContainerOrBaseBlock(Material mat){
        return mat.equals(Material.CHEST) || mat.equals(Material.TRAPPED_CHEST) || ItemSorter.versionHandler.isBarrelType(mat) || mat.equals(Material.ENDER_CHEST);
    }

    public static boolean isSign(Block block){
        return ItemSorter.versionHandler.isWallSign(block);
    }
